...
AB2[, c("k_2", "k_3", "epsilon", "phi", "N_t", "k")] <-  B[, c("k_2", "k_3", "epsilon", "phi", "N_t", "k")] # Model uncertainties
...
## ----plot_sobol_indices, cache=TRUE, dependson=c("sensitivity_analysis", "sobol_indices_f"), fig.height=4.5, fig.width=5.4----
