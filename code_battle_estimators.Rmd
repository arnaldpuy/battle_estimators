...
author: "Arnald Puy, Samuele Lo Piano, William Becker and Andrea Saltelli"
header-includes:
...
```{r map_negative, cache=TRUE, dependson="arrange_output", fig.height=5, fig.width=4.7}
...
```{r plot_full, cache=TRUE, dependson="arrange_output", fig.height=7.3, fig.width=4.2}
...
```{r plot_ratio, cache=TRUE, dependson="plot_full", fig.height=4, fig.width=4.7}
...
```{r plot_medians, cache=TRUE, dependson="arrange_output", fig.width=4.5, fig.height=3}
...
```{r plot_sobol_indices, cache=TRUE, dependson=c("sensitivity_analysis", "sobol_indices_f"), fig.height=5, fig.width=4.7}
...
```{r second_order, cache=TRUE, dependson=c("sensitivity_analysis", "plot_sobol_indices"), fig.height=3, fig.width=4.3}
