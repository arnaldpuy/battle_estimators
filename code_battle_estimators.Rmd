...
```{r sampling_method, cache=TRUE, fig.width=5, fig.height=2.5}
...
```{r plot_functions_metafunction, cache=TRUE, dependson="functions_metafunction", fig.height=2.7, fig.width=5, fig.cap="Functions used in the metafunction of @Becker2019."}
...
```{r plot_function_distributions, cache=TRUE, dependson=c("function_distributions", "function_distributions"), fig.height=2.7, fig.width=4.6, fig.cap="Distributions used in the metafunction of @Becker2019."}
...
```{r metafunctions_distributions, cache=TRUE, dependson=c("functions_metafunction", "function_distributions", "plot_functions_metafunction", "plot_function_distributions"), fig.height=5, fig.width=5}
...
```{r show_metafunction, cache=TRUE, dependson=c("metafunction", "function_distributions", "sobol_indices_f", "sobol_matrices_functions"), fig.width=5.3, fig.height=3.5}
...
```{r functions_check_metafunction, cache=TRUE}
...
```{r functions_check_metafunction2, cache=TRUE, dependson="functions_check_metafunction"}
...
```{r plot_proportion_meta, cache=TRUE, dependson="functions_check_metafunction2", fig.height=2.8, fig.width=4.8}
...
```{r export_matrix, cache=TRUE, dependson="sample_matrix"}
...
```{r define_model, cache=TRUE, dependson=c("sample_matrices_functions", "metafunction", "ti_indices", "savage_scores", "vars_functions")}
...
```{r model_run, cache=TRUE, dependson=c("define_model", "settings", "sample_matrix")}
...
```{r plot_negative, cache=TRUE, dependson="arrange_output", fig.height=3, fig.width=3.5}
...
```{r map_negative, cache=TRUE, dependson="arrange_output", fig.height=4.5, fig.width=5.2}
...
```{r plot_full, cache=TRUE, dependson="arrange_output", fig.height=5.7, fig.width=5.3}
...
```{r plot_ratio, cache=TRUE, dependson="plot_full", fig.height=4, fig.width=5.2}
...
```{r plot_boxplot, cache=TRUE, dependson="arrange_output", fig.width=4, fig.height=3}
...
```{r plot_medians, cache=TRUE, dependson="arrange_output", fig.width=4.5, fig.height=2.8}
...
```{r plot_n_ratio, cache=TRUE, dependson=c("arrange_output", "plot_medians"), fig.height=4, fig.width=5}
...
```{r scatter_sensitivity, cache=TRUE, dependson="arrange_output", fig.height=4.7, fig.width=4.7}
...
```{r plot_sobol_indices, cache=TRUE, dependson=c("sensitivity_analysis", "sobol_indices_f"), fig.height=7.2, fig.width=5.4}
...
```{r plot_sobol_indices_unnorm, cache=TRUE, dependson=c("sensitivity_analysis", "sobol_indices_f"), fig.height=6.5, fig.width=5.4}
...
```{r sum_si, cache=TRUE, dependson="sensitivity_analysis", fig.height=3, fig.width=3.5}
...
```{r second_order, cache=TRUE, dependson=c("sensitivity_analysis", "plot_sobol_indices"), fig.height=2.5, fig.width=4.7}
...
```{r export_indices, cache=TRUE, dependson="sensitivity_analysis"}
...
```{r plot_explorativity, cache=TRUE, dependson="explorativity", fig.width=4.7, fig.height=2.8}
...
```{r plot_explorativity2, cache=TRUE, dependson="explorativity", fig.width=4.7, fig.height=7}
...
```{r double_check_performance, echo = FALSE, cache=TRUE}
...
```{r plot_double_check, dependson="double_check_performance", fig.height=8, fig.width=5, echo=FALSE, cache=TRUE}
...
```{r plot_double_check_N, dependson="double_check_performance", cache= TRUE, fig.height=1.5, fig.width=5, echo=FALSE}
...
```{r plot_all_check, dependson=c("plot_double_check_N", "plot_double_check"), cache=TRUE, fig.height=7, fig.width=5, echo=FALSE}
